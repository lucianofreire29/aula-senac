...
produtos = [
    ...
    {"nome": "suco de laranja", "preco": 4.50, "categoria": "bebida"},
...
# fiz um def para cada opção do menu, puxando a função pra opção desejada
...
# coloquei os def aqui para montar o menu
